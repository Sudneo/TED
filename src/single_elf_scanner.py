...
class single_elf_scanner:
    ...
    def __init__(self,elf_scan, full_path):
        ...
        self.section_report = json.loads(self.elfscan.get_sections(full_path))
        self.sssp_report = self.elfscan.get_sssp(full_path)
    ...
    def scan(self):
        ...
        """
        print bcolors.OKGREEN+"Examinating file "+self.full_path+bcolors.ENDC
        ...
        a,b,c = scorer.get_elf_score(report_json)
        print bcolors.OKBLUE+self.full_path+" scored "+bcolors.WARNING+str(a+b+c)+bcolors.ENDC+bcolors.OKBLUE+"/100"+bcolors.ENDC
        return report_json
